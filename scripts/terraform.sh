...
OS="${1:?Usage: $0 <os> <persona> <apply|destroy> <0|1>}"
PERSONA="${2:?Usage: $0 <os> <persona> <apply|destroy> <0|1>}"
MODE="${3:?Usage: $0 <os> <persona> <apply|destroy> <0|1>}"
APPROVE="${4:?Usage: $0 <os> <persona> <apply|destroy> <0|1>}"

TF_DIR="terraform/$OS/$PERSONA"
