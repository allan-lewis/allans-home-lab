locals {
  ...
  hosts_json_path = "${path.module}/../../../infra/os/truenas/personas/nas/spec/terraform.json"

  # Logical template refs → manifest JSON files for this persona
  template_manifest_map = {
    "truenas/nas/stable" = "${path.module}/../../../infra/os/truenas/spec/vm-template-stable.json"
