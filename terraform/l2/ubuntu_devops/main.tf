locals {
  ...
  hosts_json_path = "${path.module}/../../../infra/os/ubuntu/personas/devops/spec/terraform.json"

  # Logical template refs → manifest JSON files for this persona
  template_manifest_map = {
    "ubuntu/devops/stable" = "${path.module}/../../../infra/os/ubuntu/spec/vm-template-stable.json"
