locals {
  ...
  hosts_json_path = "${path.module}/../../../infra/os/nixos/personas/devops/spec/terraform.json"

  # Logical template refs → manifest JSON files for this persona
  template_manifest_map = {
    "nixos/devops/stable" = "${path.module}/../../../infra/os/nixos/spec/vm-template-stable.json"
